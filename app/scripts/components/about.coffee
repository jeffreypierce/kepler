...
About = React.createClass
  ...
  render: ->
    (
      <div className={"about "+@state.navbarState.openClass}>
        <div className="grid_3">&nbsp;</div>
        <div className="grid_6">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature
